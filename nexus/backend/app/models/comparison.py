...
class Comparison(Base):
    ...
    status: Mapped[ComparisonStatus] = mapped_column(
        ...
        default=ComparisonStatus.pending_review,
        nullable=False,
    )

    # Versionamento (RF32 / RN16)
    is_definitive: Mapped[bool] = mapped_column(
    ...
    result = relationship(
        "ComparisonResult", back_populates="comparison", uselist=False
    )
...
class ComparisonResult(Base):
    ...
    # Feedback por sugestão (RF30 / M-FDB1)
    # { "0": "up", "1": "down", ... }
